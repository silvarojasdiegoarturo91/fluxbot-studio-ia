...
capture_frontend_env() {
  ...
  FRONTEND_DEV_STORE="${REQUESTED_DEV_STORE:-${SHOPIFY_SHOP:-${SHOPIFY_DEV_STORE_URL:-}}}"
  FRONTEND_DEV_STORES="${REQUESTED_DEV_STORES:-${SHOPIFY_DEV_STORES:-}}"
...
if [[ -n "${FRONTEND_DEV_STORE}" ]]; then
  FRONTEND_DEV_STORE="${FRONTEND_DEV_STORE#http://}"
  FRONTEND_DEV_STORE="${FRONTEND_DEV_STORE#https://}"
  FRONTEND_DEV_STORE="${FRONTEND_DEV_STORE%%/*}"
  frontend_env_cmd+=(
    "SHOPIFY_SHOP=${FRONTEND_DEV_STORE}"
    "SHOPIFY_DEV_STORE_URL=${FRONTEND_DEV_STORE}"
  )
fi

if [[ -n "${FRONTEND_DEV_STORES}" ]]; then
  frontend_env_cmd+=("SHOPIFY_DEV_STORES=${FRONTEND_DEV_STORES}")
fi
